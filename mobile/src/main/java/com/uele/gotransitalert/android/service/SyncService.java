...
package com.uele.gotransitalert.android.service;
...
import com.uele.gotransitalert.android.di.component.DaggerServiceComponent;
import com.uele.gotransitalert.android.di.component.ServiceComponent;
...
public class SyncService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        AlertLogger.d(TAG, "SyncService started");
        return START_STICKY;
    }

    @Override
    public void onDestroy() {
        AlertLogger.d(TAG, "SyncService stopped");
        super.onDestroy();
    }
