...
public abstract class BaseSubView
        extends ViewGroup implements SubAlertView {

    private AlertView mParentAlertView;
    ...
    @Override
    public void attachParentScrView(AlertView alertView) {
        mParentAlertView = alertView;
    }
}
