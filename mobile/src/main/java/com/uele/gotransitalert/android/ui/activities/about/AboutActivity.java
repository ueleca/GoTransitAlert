...
public class AboutActivity
        extends BaseActivity implements AboutAlertView {

    private static final String EXTRA_EDIT = "EDIT";

    @Inject
    AboutAlertPresenter<AboutAlertView> mAboutPresenter;
    ...
    public static void start(Activity activity, Boolean edit) {
        Intent starter = new Intent(activity, AboutActivity.class);
